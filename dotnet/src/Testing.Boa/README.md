...
[![NugetPackage](https://img.shields.io/nuget/v/Datagrove.Testing.Boa?label=NuGet%20Package)](https://www.nuget.org/packages/Datagrove.Testing.Boa/)
[![NugetDownloads](https://img.shields.io/nuget/dt/Datagrove.Testing.Boa)](https://www.nuget.org/stats/packages/Datagrove.Testing.Boa?groupby=Version)
...
`Datagrove.Testing.Boa` is the interaction library for [Selenium WebDriver](https://www.selenium.dev/).
...
* See the latest changes in the [project changelog](https://github.com/q2ebanking/boa-constrictor/blob/main/Datagrove.Testing.Boa/CHANGELOG.md).
