...
namespace Datagrove.Testing.Boa
{
    ...
    public class AddBrowserCookie : AbstractWebTask
    {
        ...
        private AddBrowserCookie(Datagrove.Testing.Selenium.Cookie cookie) => Cookie = cookie;
        ...
        /// </summary>
        private Datagrove.Testing.Selenium.Cookie Cookie { get; set; }
        ...
        /// <param name="cookie">The cookie to add to the WebDriver.</param>
        /// <returns></returns>
        public static AddBrowserCookie Named(Datagrove.Testing.Selenium.Cookie cookie) =>
        ...
        public static AddBrowserCookie Named(string name, string value) =>
            Named(new Datagrove.Testing.Selenium.Cookie(name, value));
