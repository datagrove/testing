...
[![NugetPackage](https://img.shields.io/nuget/v/Boa.Constrictor.Playwright?label=NuGet%20Package)](https://www.nuget.org/packages/Boa.Constrictor.Playwright/)
[![NugetDownloads](https://img.shields.io/nuget/dt/Boa.Constrictor.Playwright)](https://www.nuget.org/stats/packages/Boa.Constrictor.Playwright?groupby=Version)
...
`Boa.Constrictor.Playwright` is the interaction library for [Selenium WebDriver](https://www.selenium.dev/).
...
* See the latest changes in the [project changelog](https://github.com/q2ebanking/boa-constrictor/blob/main/Boa.Constrictor.Playwright/CHANGELOG.md).
